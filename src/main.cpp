...
int main(int argc, char **argv){
    ...
    my_param.sim_traj_path = "/home/larrydong/codeGit/extrinsics_eskf/imu_generator/data/testdata-quart.txt";   // input quart format.
    ...
    string imu_save_path = "/home/larrydong/codeGit/extrinsics_eskf/imu_generator/data/imu.csv";
